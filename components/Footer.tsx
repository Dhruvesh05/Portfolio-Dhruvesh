        ...
        <div className="py-12 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
            ...
            <div className="text-center md:text-left">
              <h3 className="text-xl md:text-2xl font-bold mb-4">Dhruvesh Patil</h3>
              <p className="text-sm opacity-70 leading-relaxed">
                Full Stack Developer & Designer passionate about creating innovative web solutions.
              </p>
            </div>
            ...
            {/* More Links */}
            <div className="text-center md:text-left">
              <h4 className="text-base md:text-lg font-semibold mb-4">Explore</h4>
              <ul className="space-y-2">
                {[
