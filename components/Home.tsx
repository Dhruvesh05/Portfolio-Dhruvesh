      ...
      <section className="relative z-10 bg-white/80 dark:bg-black/80 backdrop-blur-md">
        ...
        <div id="about" className="py-16 md:py-24 px-4 md:px-6 max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            {/* About Me Card */}
            <div className="rounded-2xl bg-white dark:bg-neutral-900 p-6 md:p-8 hover:shadow-xl transition-all duration-300">
            ...
            {/* Education Card */}
            <div id="education" className="rounded-2xl bg-white dark:bg-neutral-900 p-6 md:p-8 hover:shadow-xl transition-all duration-300">
        ...
        <div className="px-4 md:px-6 pb-16 md:pb-24 max-w-6xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-0">
            {portfolioStats.map((stat) => (
              <div
                key={stat.label}
                className="rounded-none bg-white dark:bg-neutral-900 p-5 md:p-6 shadow-lg transition-transform duration-300 hover:bg-black hover:text-white hover:shadow-2xl dark:hover:bg-white dark:hover:text-black"
              >
        ...
        <div id="skills" className="py-16 md:py-24 px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
              ...
              <div className="group rounded-2xl md:rounded-3xl bg-white dark:bg-neutral-900 p-6 md:p-8 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300">
        ...
        {/* ================= FEATURED PROJECTS (scroll-pinned horizontal) ================= */}
        <FeaturedProjects />
        ...
        <div id="contact" className="py-16 md:py-24 px-4 md:px-6 max-w-5xl mx-auto">
          ...
          <div className="rounded-4xl bg-white dark:bg-neutral-900 p-8 md:p-12 hover:shadow-xl transition-all duration-300">
            {/* Location */}
