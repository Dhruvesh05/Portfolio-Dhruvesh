        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-3 md:gap-4 mb-6 md:mb-8">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full border-2 border-black dark:border-white flex items-center justify-center hover:bg-gradient-to-br hover:from-[#F58529] hover:via-[#DD2A7B] hover:to-[#8134AF] hover:text-white hover:border-transparent transition-all duration-300 shadow-md hover:shadow-xl"
