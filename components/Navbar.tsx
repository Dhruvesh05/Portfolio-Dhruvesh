...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 px-3 sm:px-4 pt-3">
      <nav
        className={`w-full rounded-2xl transition-all duration-300 ${isScrolled
          ? 'bg-white/60 dark:bg-black/60 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.18)] dark:shadow-[0_8px_32px_rgba(255,255,255,0.08)] border border-black/10 dark:border-white/15'
          : 'bg-white/40 dark:bg-black/40 backdrop-blur-lg shadow-[0_4px_24px_rgba(0,0,0,0.10)] dark:shadow-[0_4px_24px_rgba(255,255,255,0.05)] border border-black/8 dark:border-white/10'
          }`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center items-center h-14 md:h-16 relative">
            ...
            {/* Desktop Menu */}
            <div
              className={`hidden md:flex items-center bg-transparent border rounded-lg overflow-hidden transition-all duration-300 ${isScrolled ? 'border-black/10 dark:border-white/20' : 'border-black/10 dark:border-transparent'
                }`}
            >
              {[
                ['Home', '/'],
